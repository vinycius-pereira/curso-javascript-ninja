...
(function () {
  ...
  */
  function calculator(checkOperator) {
    if (!isOperatorValid(checkOperator)) {
      return false
    }
    return function (num1, num2) {
      return num1 !== Number || num2 !== Number ? operation[checkOperator](num1, num2) : false
    };
  }
  ...
  */
  function showErrorMessage(operacaocalculo) {
      return 'Operação ' + operacaocalculo + ' não é permitida!'
  }
...
var operationSignal;
  ...
  */
  operationSignal = '-';
  var subtration = calculator(operationSignal);
  if(subtration){
    number1 = 50;
    number2 = 10;
    console.log(showOperationMessage(operationSignal,number1,number2),subtration(number1,number2))
  }else {
    console.log(showErrorMessage(operationSignal))
  }
  operationSignal = '*';
  ...
  */
  operationSignal = 'bananinha amassada';
  var banana = calculator(operationSignal);
  if(banana){
    number1 = 555555;
    number2 = 321;
    console.log(showOperationMessage(operationSignal,number1,number2),banana(number1,number2))
  }else {
    console.log(showErrorMessage(operationSignal))
  }
})();
