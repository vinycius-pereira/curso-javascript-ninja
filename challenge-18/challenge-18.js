(function () {
  ...
  */
  ...
  var cpfList = ['049-214 3421-1', '210.458.522-05', '735 500 794 - 22', '101.123-131x32'];
  ...
  */
  ...
  cpfList.forEach(function (cpf) {
    return console.log(cleanCPF(cpf).replace(regexCPF, '$1.$2.$3-$4'));
  })
  ...
  */
  ...
  var regexCompleteTag = /<\w+><\/\w+>/g
  console.log('<div><ul><li></li><li></li><li><span></span></li></ul></div>'.match(regexCompleteTag));
  ...
  */
  ...
  console.log('<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>'.replace(
    regexText,'$1O texto dentro da tag "$1" é "$2"$3\n'
  ))
})();
