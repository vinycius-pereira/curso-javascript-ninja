(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g,'Vinícius Pereira Nascimento'));
  ...
  */
  ...
  function getMonthNumber(monthDate) {
    var month = {
      'janeiro': '01',
      'fevereiro': '02',
      'março': '03',
  ...
  getMonthNumber('marco');
  console.log('O mês de ' + 'março' + ' é representado pelo número ' + getMonthNumber('março') + '.');
  console.log('O mês de ' + 'setemrbo' + ' é representado pelo número ' + getMonthNumber('setembro') + '.');
