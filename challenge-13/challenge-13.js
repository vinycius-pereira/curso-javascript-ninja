(function () {
  ...
  */
  var sul = ['Curitiba', 'Porto Alegre', 'Joinville', 'Londrina'];
  ...
  */
  ...
  brasil.unshift('Pará', 'Tocantis', 'Rondônia');
  console.log(brasil);
  ...
  */
  var nordeste = ['Sergipe', 'Rio Grande do Norte', 'Bahia'];
  ...
  */
  ...
  chamada `newSudeste`.
  */
  var newSudeste = brasil.slice(6, 10);
  /*
  ...
  */
  ...
  brasil.every(function (item) {
    if (item.length > 7) {
      return verifySeven = 'Sim, todos os estados tem mais de 7 letras!';
    }
    return verifySeven = 'Nem todos os estados tem mais de 7 letras!';
  });
  console.log(verifySeven);
  ...
  */
  ...
  brasil.some(function (item) {
    return item === 'Ceará' ? ceara = 'Ceará está incluído!' : ceara = 'Ceará não foi incluído'
  })
  console.log(ceara);
