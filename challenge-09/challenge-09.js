...
(function () {
  ...
  */
  var subtraction = calculator(200, 57);
  var multiplication = calculator(5, 100);
  var divison = calculator(1200, 16);
  var mod = calculator(50, 13);
  ...
  */
  ...
  console.log('O resultado da divisão é: ' + divison(function (number1, number2) {
    return number1 / number2
  }));
