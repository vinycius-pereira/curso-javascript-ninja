...
*/
pessoa.nomeCompleto(); // Vinicius Nascimento
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso(); // 68

/*
Qual a altura da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura(); // 1.78
...
pessoa.sexo = 'F';
console.log(pessoa.apresentacao()); // retorna apenas a var feminino
pessoa.sexo = 'M';
pessoa.idade = 1;
console.log(pessoa.apresentacao()); // retorna va// r recemNascido
pessoa.sexo = 'M';
pessoa.idade = 26;
pessoa.caminhouQuantosMetros = 1;
console.log(pessoa.apresentacao()); // retorna apenas a var andaPouco
